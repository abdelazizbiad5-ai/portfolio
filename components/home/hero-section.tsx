...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-emerald-800 text-white overflow-hidden px-4">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Description */}
          <p className="text-lg sm:text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 px-4">
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-blue-900 px-8 py-4 text-lg w-full sm:w-auto">
