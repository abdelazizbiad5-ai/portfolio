      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="aspect-square bg-gradient-to-br from-blue-500 to-emerald-500 rounded-2xl p-1 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">6+ Years</p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg mb-2">Projects Completed</h4>
